<?php include_once "header.php"; ?>
    ...
    if (isset($_POST["btAgregar"])) {
        ...
        $insertar = "INSERT INTO editorial VALUES('$Id','$Nombre')";
        mysqli_query($conexion, $insertar) or die(mysqli_error($conexion));
        mysqli_close($conexion);

        $_SESSION["flash"] = [
            "tipo" => "success",
            "mensaje" => "Se Agrego el Editorial, con Id {$_POST['Id']} ."
        ];
        ...
        require("conexion.php");
        $actualizar = "UPDATE editorial SET
        Id='$Id',
        Nombre='$Nombre'
        WHERE Id ='$IdOld';";
        ...
        $_SESSION["flash"] = [
            "tipo" => "warning",
            "mensaje" => "Se Modifico el Editorial, con Id {$_POST['Id']} ."
        ];
        ...
        require("conexion.php");
        $Id = $_POST['id'];
        $eliminar = "DELETE FROM editorial WHERE Id='$Id'";
        mysqli_query($conexion, $eliminar) or die(mysqli_error($conexion));
        mysqli_close($conexion);

        $_SESSION["flash"] = [
            "tipo" => "danger",
            "mensaje" => "Se Elimino el Editorial, con Id {$_POST['Id']} ."
        ];
...
<div id="tabla" class="tabla">
            <form method="post" action="editoriales.php" id="formularioEdit" style="display:none;">
                ...
                <button class="BOTON" type="submit" name="btAgregar" id="btAgregar" value="Agregar">Registrar Editorial</button>
                <button class="BOTON ocultar" name="btModificar" id="btModificar">Modificar</button>
                <button class="BOTON" name="btCancelar" id="btCancelar" onclick="CanFormEd()">Cancelar</button>
            </form>
            <a class="BOTON" id="BAN" onclick="MostrarFormEd()">Agregar Nueva Editorial</a>
                   ...
                   <tbody class="edit">
                    ...
                    ?>
                        ...
                        <tr id="<?php echo $fila['Id']; ?>">
                            ...
                            <td><a class="editar" href="#" onclick="editarEditoriales('<?php echo $fila['Id']; ?>')"><i class='bx bxs-edit-alt'></i> Editar</a></td>
                            <td>
                            <a class="eliminar" href="#" name="btEliminar" id="btEliminar" onclick="MModal('<?php echo $fila['Id']; ?>','editoriales.php')"  value="<?php echo $fila['Id']; ?>"><i class="fas fa-solid fa-trash"></i> Eliminar</a>
